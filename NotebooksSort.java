...
public class NotebooksSort {
    public static void main(String[] args) {
        ...
        laptops.add(new Notebooks("HP15sr32", "HP", 8, 512, "Windows 10", "Silver", 15.6));
        laptops.add(new Notebooks("DellXPS15", "Dell", 16, 256, "Ubuntu", "Black", 14.0));
        ...
        laptops.add(new Notebooks("HP16er34", "HP", 16, 4000, "Windows 10", "Silver", 16.0));
